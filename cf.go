...
import (
	...
	"github.com/c4lnn/cf-tool/client"
	"github.com/c4lnn/cf-tool/cmd"
	"github.com/c4lnn/cf-tool/config"
...
func main() {
	usage := `Codeforces Tool $%version%$ (cf). https://github.com/c4lnn/cf-tool
